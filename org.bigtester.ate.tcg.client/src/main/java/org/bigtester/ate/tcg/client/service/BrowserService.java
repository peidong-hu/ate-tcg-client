...
public class BrowserService {
	public static final String FIREBUGXPIPATH = System.getProperty("user.dir") + "/src/main/resources/firebug-2.0.11.xpi";
	public static final String CROSSDOMAIN = System.getProperty("user.dir") + "/src/main/resources/cors-everywhere@spenibus-20150707-1957.xpi";
	public static final String CHROMEDRIVER = System.getProperty("user.dir") + "/src/main/resources/chromedriver.exe";
	
	private static WebDriver webDriver;
	public static void initWebDriverInstance() throws IOException {
		if (webDriver == null) {
			
//			FirefoxProfile prof = new FirefoxProfile();
//			prof.addExtension(new File(FIREBUGXPIPATH));
//			prof.addExtension(new File(CROSSDOMAIN));
//			
//			prof.setPreference("security.mixed_content.block_active_content", false);
//			prof.setPreference("security.mixed_content.block_display_content", false);
//			prof.setPreference("security.fileuri.strict_origin_policy", false);
//			
...
//		AppLauncher.webView.getEngine().executeScript("if (!document.getElementById('FirebugLite')){E = document['createElement' + 'NS'] && document.documentElement.namespaceURI;E = E ? document['createElement' + 'NS'](E, 'script') : document['createElement']('script');E['setAttribute']('id', 'FirebugLite');E['setAttribute']('src', 'https://getfirebug.com/' + 'firebug-lite.js' + '#startOpened');E['setAttribute']('FirebugLite', '4');(document['getElementsByTagName']('head')[0] || document['getElementsByTagName']('body')[0]).appendChild(E);E = new Image;E['setAttribute']('src', 'https://getfirebug.com/' + '#startOpened');}");
	...
	public boolean launchUserHomepage2(String url) throws IOException {
