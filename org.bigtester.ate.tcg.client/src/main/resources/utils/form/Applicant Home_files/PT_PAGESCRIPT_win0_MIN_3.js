...
function TDAHeader()
{
var myURL =(window.location.href);if (myURL.indexOf('/apply-dev3.tdameritrade.com/')!= -1){
var hdrLoc = 'RS91QA/images/logo_tda.gif';}
if (myURL.indexOf('/apply.tdameritrade.com/')!= -1){
var hdrLoc = 'HR91RCE/images/logo_tda.gif';}




if (myURL.indexOf('/tx-apply.tdameritrade.com/')!= -1){
var hdrLoc = 'HR91RCE/images/logo_tda.gif';}
if (myURL.indexOf('/jc-apply.tdameritrade.com/')!= -1){
var hdrLoc = 'HR91RCE/images/logo_tda.gif';}

if (myURL.indexOf('tdameritrade.com')!= -1){

 theBody = document.getElementsByName('ICFirstAnchor_win0')[0]; hdrmask = document.createElement('div'); hdrmask.id = 'hdrMask'; hdrmask.innerHTML = '' +
 '<div id="TDAHdr">' +
 '<span style="border-width: 0"><img style="margin-top:5px;" src="/'+ hdrLoc +'" alt="TD Ameritrade"></span></div></div>'; theBody.appendChild(hdrmask); document.title='TD Ameritrade Careers';  setFocus_win0('HRS_APPL_WRK_HRS_TRANSACT_TITLE',-1); setFocus_win0('HRS_APP_CAR_DRV_HRS_JOB_SEARCH',-1);}
}
